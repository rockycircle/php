...
class DevicePayload {
    ...
    public function updateDevice($registrationId, $alias = null, $mobile=null, $addTags = null, $removeTags = null) {
        ...
        if (!is_string($registrationId)) {
            throw new \Exception('Invalid registration_id');
        }
        ...
        if ($aliasIsNull && $addTagsIsNull && $removeTagsIsNull && $mobileIsNull) {
            throw new \Exception("alias, addTags, removeTags not all null");
        }
        ...
        if (!$mobileIsNull) {
            if (is_string($mobile)) {
                ...
                throw new \Exception("Invalid mobile string");
            }
        }
        ...
        if (!$addTagsIsNull) {
            if (is_array($addTags)) {
                ...
                throw new \Exception("Invalid addTags array");
            }
        }
        ...
        if (!$removeTagsIsNull) {
            if (is_array($removeTags)) {
                ...
                throw new \Exception("Invalid removeTags array");
            }
        }
    ...
    public function updateTag($tag, $addDevices = null, $removeDevices = null) {
        ...
        if ($addDevicesIsNull && $removeDevicesIsNull) {
            throw new \Exception("Either or both addDevices and removeDevices must be set.");
        }
        ...
        if (!$addDevicesIsNull) {
            if (is_array($addDevices)) {
                ...
                throw new \Exception("Invalid addDevices");
            }
        }
        ...
        if (!$removeDevicesIsNull) {
            if (is_array($removeDevices)) {
                ...
                throw new \Exception("Invalid removeDevices");
            }
        }
