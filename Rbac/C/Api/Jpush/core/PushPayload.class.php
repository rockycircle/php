<?php
namespace Rbac\C\Api\Jpush\core;
...
class PushPayload {
    ...
    public function setPlatform($platform) {
        if (is_string($platform) && strcasecmp("all", $platform) === 0) {
            ...
            if (!is_array($platform)) {
                ...
                if (count($platform) <= 0) {
                    throw new \Exception("Missing argument for PushPayload::setPlatform()");
                }
            }
    ...
    public function addTagAnd($tag) {
        ...
        if (is_array($tag)) {
            foreach($tag as $_tag) {
                if (!is_string($_tag)) {
                    throw new \Exception("Invalid tag_and value");
                }
        ...
        if (is_array($registrationId)) {
            foreach($registrationId as $_registrationId) {
                if (!is_string($_registrationId)) {
                    throw new \Exception("Invalid registration_id value");
                }
    ...
    public function setNotificationAlert($alert) {
        if (!is_string($alert)) {
            throw new \Exception("Invalid alert value");
        }
    ...
    public function addIosNotification($alert=null, $sound=null, $badge=null, $content_available=null, $category=null, $extras=null) {
        ...
        if (!is_null($alert)) {
            if (!is_string($alert) && !is_array($alert)) {
                throw new \Exception("Invalid ios alert value");
            }
            $ios['alert'] = $alert;
        }
        ...
        if (!is_null($sound)) {
            if (!is_string($sound)) {
                throw new \Exception("Invalid ios sound value");
            }
        ...
        if (!is_null($badge)) {
            if (is_string($badge) && !preg_match("/^[+-]{1}[0-9]{1,3}$/", $badge)) {
                if (!is_int($badge)) {
                    throw new \Exception("Invalid ios badge value");
                }
            }
        ...
        if (!is_null($content_available)) {
            if (!is_bool($content_available)) {
                throw new \Exception("Invalid ios content-available value");
            }
        ...
        if (!is_null($category)) {
            if (!is_string($category)) {
                throw new \Exception("Invalid ios category value");
            }
            if (strlen($category)) {
        ...
        if (!is_null($extras)) {
            if (!is_array($extras)) {
                throw new \Exception("Invalid ios extras value");
            }
            if (count($extras) > 0) {
                $ios['extras'] = $extras;
            }
        ...
        if (count($ios) <= 0) {
            throw new \Exception("Invalid iOS notification");
        }
    ...
    public function addAndroidNotification($alert=null, $title=null, $builderId=null, $extras=null) {
        ...
        if (!is_null($alert)) {
            if (!is_string($alert)) {
                throw new \Exception("Invalid android alert value");
            }
            $android['alert'] = $alert;
        }
        ...
        if (!is_null($title)) {
            if(!is_string($title)) {
                throw new \Exception("Invalid android title value");
            }
            if(strlen($title) > 0) {
                $android['title'] = $title;
            }
        ...
        if (!is_null($builderId)) {
            if (!is_int($builderId)) {
                throw new \Exception("Invalid android builder_id value");
            }
        ...
        if (!is_null($extras)) {
            if (!is_array($extras)) {
                throw new \Exception("Invalid android extras value");
            }
            if (count($extras) > 0) {
        ...
        if (count($android) <= 0) {
            throw new \Exception("Invalid android notification");
        }
    ...
    public function addWinPhoneNotification($alert=null, $title=null, $_open_page=null, $extras=null) {
        ...
        if (!is_null($alert)) {
            if (!is_string($alert)) {
                throw new \Exception("Invalid winphone notification");
            }
        ...
        if (!is_null($title)) {
            if (!is_string($title)) {
                throw new \Exception("Invalid winphone title notification");
            }
            if(strlen($title) > 0) {
        ...
        if (!is_null($_open_page)) {
            if (!is_string($_open_page)) {
                throw new \Exception("Invalid winphone _open_page notification");
            }
        ...
        if (!is_null($extras)) {
            if (!is_array($extras)) {
                throw new \Exception("Invalid winphone extras notification");
            }
            if (count($extras) > 0) {
    ...
    public function setSmsMessage($content, $delay_time) {
        ...
        if (is_null($content) || !is_string($content) || strlen($content) < 0 || strlen($content) > 480) {
            throw new \Exception('Invalid sms content, sms content\'s length must in [0, 480]');
        } else {
            $sms['content'] = $content;
        }

        if (is_null($delay_time) || !is_int($delay_time) || $delay_time < 0 || $delay_time > 86400) {
            throw new \Exception('Invalid sms delay time, delay time must in [0, 86400]');
        } else {
    ...
    public function setMessage($msg_content, $title=null, $content_type=null, $extras=null) {
        ...
        if (!is_null($title)) {
            if (!is_string($title)) {
                throw new \Exception("Invalid message title");
            }
            $message['title'] = $title;
        }
        ...
        if (!is_null($extras)) {
            if (!is_array($extras)) {
                throw new \Exception("Invalid message extras");
            }
            if (count($extras) > 0) {
    ...
    public function setOptions($sendno=null, $time_to_live=null, $override_msg_id=null, $apns_production=null, $big_push_duration=null) {
        ...
        if (!is_null($sendno)) {
            if (!is_int($sendno)) {
                throw new \Exception('Invalid option sendno');
            }
        ...
        if (!is_null($time_to_live)) {
            if (!is_int($time_to_live) || $time_to_live < 0 || $time_to_live > 864000) {
                throw new \Exception('Invalid option time to live, it must be a int and in [0, 864000]');
            }
        ...
        if (!is_null($override_msg_id)) {
            if (!is_long($override_msg_id)) {
                throw new \Exception('Invalid option override msg id');
            }
        ...
        if (!is_null($apns_production)) {
            if (!is_bool($apns_production)) {
                throw new \Exception('Invalid option apns production');
            }
        ...
        if (!is_null($big_push_duration)) {
            if (!is_int($big_push_duration) || $big_push_duration < 0 || $big_push_duration > 1440) {
                throw new \Exception('Invalid option big push duration, it must be a int and in [0, 1440]');
            }
    ...
    public function build() {
        ...
        if (!is_null($this->androidNotification)) {
            ...
            if (is_null($this->androidNotification['alert'])) {
                if (is_null($this->notificationAlert)) {
                    throw new \Exception("Android alert can not be null");
                } else {
        ...
        if (!is_null($this->iosNotification)) {
            ...
            if (is_null($this->iosNotification['alert'])) {
                if (is_null($this->notificationAlert)) {
                    throw new \Exception("iOS alert can not be null");
                } else {
        ...
        if (!is_null($this->winPhoneNotification)) {
            ...
            if (is_null($this->winPhoneNotification['alert'])) {
                if (is_null($this->winPhoneNotification)) {
                    throw new \Exception("WinPhone alert can not be null");
                } else {
        ...
        if (!array_key_exists('notification', $payload) && !array_key_exists('message', $payload)) {
            throw new \Exception('notification and message can not all be null');
        }
