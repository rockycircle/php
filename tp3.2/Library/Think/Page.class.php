...
class Page {
    ...
    protected $config  =   array(
            ...
            'theme'=>'<ul> %upPage%  %first%  %prePage%  %linkPage%  %nextPage% %end% %downPage%</ul>');
    
    /* protected $config  =   array('header'=>'条记录','prev'=>'上一页','next'=>'下一页','first'=>'第一页','last'=>'<span id="lastspan">最后一页</span>',
            'theme'=>'<ul><li><span> %totalRow% %header% %nowPage%/%totalPage% 页</span></li> %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%</ul>'); */
